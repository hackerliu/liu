...
public class UserDao implements IDataDao<User>{
    ...
    public UserDao(Context context,String userID){
        this.tablename="userinfo_"+userID;
    ...
    public void insert(ContentValues contentValues) {
        try {
            ...
            LogHelper.getInstance().writeLog(UserDao.class,e.getMessage());
            e.printStackTrace();
        }finally {
    ...
    public List<User> select() {
        String[] columns={"userid","psw","nickname","headimg","sex",
